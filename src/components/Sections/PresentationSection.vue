    ...
    <div
      ...
      <div
        ...
        <div class="text-xl lg:text-3xl xl:text-5xl text-center md:text-start">
          <p class="text-lightText"><span v-text="displayText1"></span></p>
          <p class="text-lightText">
            <span v-text="displayText2Part1"></span>
            <strong class="text-mustard" v-text="displayText2Part2"></strong>
            <span class="text-lightText" v-text="displayText2Part3"></span>
          </p>
          <p class="text-lightText"><span v-text="displayText3"></span></p>
        </div>
        <ProfilePic />
      </div>
      <div>
