...
<template>
  <Section title="Meus Projetos" light>
    <div class="w-full flex justify-center mb-10 2xl:mb-12 xl:-mt-4">
      <p class="text-sm md:text-base lg:text-lg 2xl:text-2xl">
        Aqui estão alguns dos meus projetos mais recentes. Sinta-se à vontade
        para explorá-los!
      </p>
    </div>
